          ...
          <b-card>
            ...
            <h5 slot="header">
              ...
              <span class="text-primary">
                ...
                <small
                  class="font-italic"
                >List of all registered Departments .</small>
              </span>
            </h5>
            <b-row class="mb-2">
              ...
              <b-col sm="4">
                <b-button
                  variant="primary"
                  @click="showModalEntry = true, entryMode='Add', clearFields('department')"
                >
              ...
              <b-col sm="12">
                ...
                >
                  ...
                  <template v-slot:cell(action)="data">
                    ...
                    <b-btn
                      :size="'sm'"
                      :disabled="forms.department.isDeleting"
                      variant="danger"
    ...
    <div>
      ...
      >
        ...
        <div slot="modal-footer">
          ...
          <b-button
            :disabled="forms.department.isSaving"
            variant="primary"
      ...
      <b-modal v-model="showModalDelete" :noCloseOnEsc="true" :noCloseOnBackdrop="true">
        <div slot="modal-title">Remove department</div>

        <b-col lg="12">Are you sure you want to Remove this department?</b-col>
        <div slot="modal-footer">
          <b-button
            :disabled="forms.department.isSaving"
            variant="primary"
